...
class Model:
    ...
    def add_lines(self, **kwargs):     self.draws.append(Polyline(self.batch, **kwargs));  return self.draws[-1]
    ...
    def update_index_list(self, update, index=None):
        if index: return update[:index] + list(map(lambda x: x-1, update[index:]))
